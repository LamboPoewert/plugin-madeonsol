...
export const kolCoordinationAction: Action = {
  ...
  examples: [
    [
      { user: "user1", content: { text: "What tokens are multiple KOLs accumulating?" } } as ActionExample,
      { user: "assistant", content: { text: "Here are the KOL convergence signals..." } } as ActionExample,
    ],
  ],
};
