...
export const deployerAlertsAction: Action = {
  ...
  examples: [
    [
      { user: "user1", content: { text: "Show me the latest deployer alerts from Pump.fun" } } as ActionExample,
      { user: "assistant", content: { text: "Here are the latest deployer alerts..." } } as ActionExample,
    ],
  ],
};
